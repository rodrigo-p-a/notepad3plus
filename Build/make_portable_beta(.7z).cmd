...
rem * Notepad3                                                                   *
rem *                                                                            *
rem * make_portable_beta(.7z).cmd                                                *
rem *   Batch file for creating "Portable beta (*.7z)" packages                  *
rem *                                                                            *
...
MOVE /Y "Notepad3_%NP3_VER%.7z" "..\Notepad3_%NP3_VER%_beta_Portable.7z" >NUL
...
:SubZipFiles
SET "ZIP_NAME=Notepad3_%NP3_VER%_beta_%2%_Portable"
