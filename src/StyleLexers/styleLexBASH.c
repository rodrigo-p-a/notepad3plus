...
KEYWORDLIST KeyWords_BASH =
{
    ...
    "deroff dev df diff diff3 dir dircmp dircolors dirname dirs do done du echo ed egrep elif else env esac eval ex "
    ...
    "mv newgrp nice nl nm nohup ntps od pack paste patch pathchk pax pcat perl pg pinky popd pr print printenv "
    "printf ps ptx pushd pwd read readlink readonly red return rev rm rmdir sed select seq set sh sha1sum shift "
...
EDITLEXER lexBASH =
{
    ...
    &KeyWords_BASH, {
        ...
        { {SCE_SH_PARAM}, IDS_LEX_STR_ParamExp, L"Parameter Expansion", L"fore:#808000; back:#FFFF99", L"" },
