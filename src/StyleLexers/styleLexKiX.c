...
KEYWORDLIST KeyWords_KiX =
{
    ...
    " cint expandenvironmentvars setwallpaper split substr",
    // macros
...
EDITLEXER lexKiX =
{
    ...
    &KeyWords_KiX, {
        ...
        { {SCE_KIX_FUNCTIONS}, IDS_LEX_STR_Function, L"Function", L"fore:#9B009B", L"" },
        { {SCE_KIX_MACRO}, IDS_LEX_STR_Macro, L"Macro", L"fore:#FFC000", L"" },
