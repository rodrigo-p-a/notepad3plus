...
EDITLEXER lexR =
{
    ...
    &KeyWords_R,{
        ...
        //{ {SCE_R_DEFAULT}, IDS_LEX_STR_Default, L"Default", L"", L"" },
        { {SCE_R_COMMENT}, IDS_LEX_STR_Comment, L"Comment", L"fore:#008000", L"" },
        { {SCE_R_KWORD}, IDS_LEX_STR_Keyword, L"Keyword", L"bold; fore:#0A246A", L"" },
        ...
        { {SCE_R_NUMBER}, IDS_LEX_STR_Number, L"Number", L"fore:#0000FF", L"" },
        { {MULTI_STYLE(SCE_R_STRING,SCE_R_STRING2,0,0)}, IDS_LEX_STR_String, L"String", L"italic; fore:#3C6CDD", L"" },
        { {SCE_R_OPERATOR}, IDS_LEX_STR_Operator, L"Operator", L"bold; fore:#B000B0", L"" },
        { {SCE_R_IDENTIFIER}, IDS_LEX_STR_Identifier, L"Identifier", L"", L"" },
        { {SCE_R_INFIX}, IDS_LEX_STR_Infix, L"Infix", L"fore:#660066", L"" },
        { {SCE_R_INFIXEOL}, IDS_LEX_STR_InfixEOL, L"Infix EOL", L"fore:#FF4000; back:#E0C0E0; eolfilled", L"" },
        { {SCE_R_BACKTICKS}, IDS_LEX_STR_Backticks, L"Backticks", L"fore:#3C6CDD", L"" },
        { {MULTI_STYLE(SCE_R_RAWSTRING,SCE_R_RAWSTRING2,0,0)}, IDS_LEX_STR_LitStrg, L"Literal String", L"italic; fore:#3C6CDD", L"" },
