...
// Primary keywords and identifiers
    ...
    "ref return self Self static struct super trait true type unsafe use while",
// Built in types
...
EDITLEXER lexRust =
{
    ...
    &KeyWords_Rust,{
        ...
        { {SCE_RUST_WORD2}, IDS_LEX_STR_63343, L"Built-In Type", L"fore:#A9003D", L"" },
        ...
        //{ {SCE_RUST_WORD7}, IDS_LEX_STR_Keyword, L"Keyword 7", L"bold; fore:#0A246A", L"" },
        ...
        { {MULTI_STYLE(SCE_RUST_CSTRING,SCE_RUST_CSTRINGR,0,0)}, IDS_LEX_STR_CStr, L"C String", L"fore:#5C800F", L"" },
        EDITLEXER_SENTINEL
    }
};
