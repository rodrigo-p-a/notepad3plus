...
EDITLEXER lexVHDL =
{
    ...
    &KeyWords_VHDL, {
        ...
        //{ {SCE_VHDL_DEFAULT}, IDS_LEX_STR_Default, L"Default", L"", L"" },
        { {MULTI_STYLE(SCE_VHDL_COMMENT, SCE_VHDL_COMMENTLINEBANG, SCE_VHDL_BLOCK_COMMENT, 0)}, IDS_LEX_STR_Comment, L"Comment", L"fore:#008800", L"" },
        { {SCE_VHDL_NUMBER}, IDS_LEX_STR_Number, L"Number", L"fore:#FF0000", L"" },
        { {MULTI_STYLE(SCE_VHDL_STRING, SCE_VHDL_STRINGEOL, 0, 0)}, IDS_LEX_STR_String, L"String", L"fore:#008000", L"" },
        { {SCE_VHDL_OPERATOR}, IDS_LEX_STR_Operator, L"Operator", L"fore:#007F7F", L"" },
        { {SCE_VHDL_IDENTIFIER}, IDS_LEX_STR_Identifier, L"Identifier", L"", L"" },
        { {SCE_VHDL_KEYWORD}, IDS_LEX_STR_Keyword, L"Keyword", L"bold; fore:#0000A4", L"" },
        { {SCE_VHDL_STDOPERATOR}, IDS_LEX_STR_StdOp, L"Standard Operator", L"bold; fore:#0A246A", L"" },
        { {SCE_VHDL_ATTRIBUTE}, IDS_LEX_STR_Attrib, L"Attribute", L"fore:#804020", L"" },
        { {SCE_VHDL_STDFUNCTION}, IDS_LEX_STR_StdFct, L"Standard Function", L"fore:#808020", L"" },
        { {SCE_VHDL_STDPACKAGE}, IDS_LEX_STR_StdPck, L"Standard Package", L"fore:#208020", L"" },
        { {SCE_VHDL_STDTYPE}, IDS_LEX_STR_StdTyp, L"Standard Type", L"fore:#208080", L"" },
        { {SCE_VHDL_USERWORD}, IDS_LEX_STR_Const, L"Constant", L"fore:#804020", L"" },
        EDITLEXER_SENTINEL
    }
};
